...
namespace GranadoEspadaHeadless.Network.Packets
{
    public class PacketWriter : IDisposable
    {
        ...
        public void WriteFullPacket(byte[] value)
        {        
            ushort opcode = BitConverter.ToUInt16(value, 0);
            WriteUShort(opcode);
            WriteInt(Factory.packetCount);
            WriteInt(0);
            WriteBytes(value, 10, value.Length - 10);
            Factory.packetCount += 1;
        }
